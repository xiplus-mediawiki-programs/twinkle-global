QUnit.module('MorebitsGlobal.batchOperation');
QUnit.test('Contruction', assert => {
	assert.true(new MorebitsGlobal.batchOperation() instanceof MorebitsGlobal.batchOperation, 'Correct instance');
});
var batch = new MorebitsGlobal.batchOperation();
