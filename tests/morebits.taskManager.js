QUnit.module('MorebitsGlobal.taskManager');
QUnit.test('Contruction', assert => {
	var tm = new MorebitsGlobal.taskManager();
	assert.true(tm instanceof MorebitsGlobal.taskManager, 'Correct instance');
});
...
QUnit.test('Simple', assert => {
	generateFuncs();
	var simple = new MorebitsGlobal.taskManager();
	simple.add(data.one, []);
...
QUnit.test('Complex', assert => {
	generateFuncs();
	var complex = new MorebitsGlobal.taskManager();
